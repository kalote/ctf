...
- look in the html source code (axactf{f1rst_pl4c3_t0_l00k_a7_1n_4_c7f})
- check /robots.txt to find /the/hid/den/path/to/a/new/flag (axactf{r0b0ts_4r3_w4y_b3773r_7h4n_p30pl3})

## MD5

- solution: flag.js (axactf{md5_15_n0t_v3ry_53cur3_4nyw4y})

## JWT

- change alg to "none" and secretid to "null"
- create payload using flag.py (axactf{i_l0v3_c00k1e5_4nd_j50nw3b70ken})

## JWT 3

- change alg to "HS256" and provide the public key as a string
- solution: flag.js (axactf{JW7_c4n_b3_h4ck3d_1n_s0_m4ny_w4y5})

## Files

- bypass ../ filter using ..././
- check 1 folder above to get /flag.txt (axactf{pl4y1ng_w17h_f1l35_15_d4ng3rou5})

## No sequel

- NoSQL injection with $gt or $ne (axactf{n05ql_d0e5_n07_m34n_n0_1nj3ct10n})
...
- Bling NoSQL injection with $regex to get the real password (axactf{th1s_1s_called_bl1nd_5ql_1nj3ct10n})
...
- flag: axactf{s74r71ng_crypt0_101_w17h_mul71pl3_st3ps}
```python
b = int(binary, 2)
h = hex(b)
...
- flag: axactf{f0ll0w_7h3_gu1d3_4nd_kn0w_y0ur_r3que57}
...
- flag: axactf{3x1t_c0d3_4r3_very_p0w3rfull_7h1ng5}
